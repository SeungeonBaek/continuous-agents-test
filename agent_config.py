...
# PPO
PPO_Vanilla_agent_config = {'agent_name': 'PPO', 'gamma' : 0.99, 'total_batch_size': 2048, 'batch_size': 1024, 'epoch_num': 30, \
                            'entropy_coeff': 0.01, 'entropy_coeff_reduction_rate': 0.9998, 'entropy_coeff_min': 0.001, \
                            'epsilon': 0.2, 'std_bound': [0.025, 0.25], 'lr_actor': 0.0002, 'lr_critic': 0.0003, 'reward_normalize' : True, \
