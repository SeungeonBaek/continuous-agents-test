            ...
            if self.agent_config['extension']['name'] == 'SIL':
                ...
                for _ in range(Agent.sil_epoch):
                    ...
                    if sil_updated:
                        ...
                        self.summary_writer.add_scalar('02_Critic/SIL_Advantage', sil_adv, Agent.sil_update_step)
                        ...
                        self.summary_writer.add_scalar('03_Actor/SIL_Return_Criteria', Agent.return_criteria, Agent.sil_update_step)
